...
public class BlockGrinder extends BlockContainer implements ItemModelProvider
{
	public final String name = "machineGrinder";
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ)
	{
		...
		player.openGui(NuclearEngineering.instance, GUI_ID.GRINDER, world, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
