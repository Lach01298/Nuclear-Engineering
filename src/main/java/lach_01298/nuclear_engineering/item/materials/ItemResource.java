...
public class ItemResource extends Item implements ItemModelProvider
{
	...
	public void registerItemModel(Item item)
	{
		...
		{
			NuclearEngineering.proxy.registerItemRenderer(this, i, name +EnumType.values()[i].getName());
		}
